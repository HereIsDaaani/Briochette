...
(function () {
  ...
  /* ========================================================
     ...
     ======================================================== */
  var SHEET_ID = '1q7LtZRwDl5DmnR0F986u2rtrPYal-fMjE5u0i2mzFQk';
  ...
  var MENU_DATA = [
    {
      ...
      dishes: [
        ...
        { name: 'Latte caramel', price: '4,50 €' },
        { name: 'Latte vanille', price: '4,50 €' },
        { name: 'Latte pistache', price: '4,50 €' },
        { name: 'Ube latte', price: '5,00 €' },
        { name: 'Chaï latte', price: '5,00 €' },
        { name: 'Matcha latte', price: '5,00 €' },
        { name: 'Pumpkin latte', price: '5,00 €' },
        { name: 'Marshmallow latte', price: '5,00 €' },
        { name: 'Chocolat chaud', price: '4,50 €' },
        { name: 'Thé vert, thé noir ou infusion', unit: '(Palais des Thés)', price: '4,00 €' }
      ]
    },
    {
      category: 'Boissons froides',
      dishes: [
        { name: 'Citronnade maison', price: '5,50 €' },
        { name: 'Orange pressée', price: '4,50 €' },
        { name: 'Smoothie banane vanille', price: '4,50 €' },
        { name: 'Eau Evian', price: '2,00 €' },
        { name: 'Perrier', price: '2,50 €' },
        { name: 'Cola artisanal français Fizz', price: '3,50 €' },
        { name: 'Limonade artisanale Fizz', price: '3,50 €' },
        { name: 'Sirop', price: '2,00 €' },
        { name: 'Iced Americano', price: '3,50 €' },
        { name: 'Iced Latte', price: '4,50 €' },
        { name: 'Iced Caramel Latte', price: '5,00 €' },
        { name: 'Iced Chocolate cookie latte', price: '5,00 €' },
        { name: 'Iced Pistachio latte', price: '5,00 €' },
        { name: 'Iced Matcha Latte / fraise / mangue', price: '5,00 €' },
        { name: 'Iced Ube Latte', price: '5,00 €' }
      ]
    },
    {
      category: 'Cookies',
      dishes: [
        { name: 'Cookies du jour', price: '3,50 €' }
      ]
    },
    {
      category: 'Cake',
      dishes: [
        { name: 'Cake du jour', price: '3,50 €' }
      ]
    },
    {
      category: 'Brioches & rolls',
      dishes: [
        { name: 'Brioche à la cannelle', price: '4,00 €' },
        { name: 'Rolls du jour', price: '4,50 €' }
      ]
    },
    {
      category: 'Box à partager',
      dishes: [
        { name: '4 cookies', price: '12,00 €' },
        { name: '4 financiers', price: '12,00 €' },
        { name: '4 brioches', price: '14,00 €' }
      ]
    },
    {
      category: 'Petit-déjeuner',
      dishes: [
        { name: 'Granola maison, fruits de saison, fromage blanc, sirop d\'érable', price: '7,00 €', desc: 'Option yaourt végétal disponible.' },
        { name: 'Brioche toastée, beurre & confiture ou nocciolata', price: '4,50 €' }
      ]
    }
  ];
   ...
   * Lundi-Mardi : Fermé / Mercredi-Vendredi : 09:00–17:00 /
   * Samedi : 10:00–17:00 / Dimanche : 10:00–15:00
   */
